                ...
                children: [
                  ...
                  if (state is HomeLoading)
                    ...
                    if (state is HomeLoaded)
                                  ...
                                  Expanded(
                                    child: Padding(
                                      ...
                                      child: state.flights.isNotEmpty
                                          ...
                                          shrinkWrap: true,
                                          scrollDirection: Axis.horizontal,
                                          itemCount: state.flights.length + 1,
                                          itemBuilder: (BuildContext context, int index) {
                                                ...
                                                child: Center(
                                                  child: MaterialButton(
                                                    ...
                                                    color: Theme
                                                        ...
                                                        .primaryColor,
                                                    onPressed: () =>
                                                        BlocProvider.of<HomeBloc>(context).add(HomeLoadMoreFlights()),
                                                  ),
                                                ),
                                              );
                                            return FlightCard(
                      ...
                      Expanded(
                          child: ErrorButtonWidget(callback: () => BlocProvider.of<HomeBloc>(context).add(HomeInit())))
                ],
              );
            }),
          ),
